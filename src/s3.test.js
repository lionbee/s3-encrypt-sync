...
describe('Tests for s3 keys', () => {
    ...
    it('Continuation token are honoured', async () => {
        ...
        mockListKeys
            .mockResolvedValueOnce({Contents: [Contents[2]], IsTruncated: true, NextContinuationToken: "1"})
            .mockResolvedValueOnce({Contents: [Contents[1]], IsTruncated: true, NextContinuationToken: "2"})
